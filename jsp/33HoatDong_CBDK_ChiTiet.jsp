...
<title>chi tiết hoạt đọng cán bộ đoàn khoa</title>
             ...
             <jsp:include page="breakingnew.jsp"/> 
               <!-- ket thuc breakingnew -->
	            ...
	            <div id="main-content">
	                    ...
	                    <div class="khungchitiet">
	                        <form class="" action="" method="POST" role="form">
	                             <div class="form-inline">
	                                ...
	                                <input type="text" name="mahd" class="form-control required name" id="" placeholder="HD01" data-trigger="manual" data-content="Bạn cần phải nhập vào trường này,ít nhất 3 ký tự.">
	                            </div>
	                            <div class="form-inline">
	                                <label class="fieldinput col-sm-4">Tên HĐ: </label>
	                                <input type="text" name="tenhd" class="form-control required name" id="" placeholder="Công tác xã hội"  data-trigger="manual" data-content="Bạn cần phải nhập vào trường này,ít nhất 3 ký tự.">
	                            </div>
	                            <div class="form-inline">
	                            ...
	                            <div class="form-inline">
	                                ...
	                                <input type="date" name="tungay" class="form-control" value="" required="required">
	                            </div>
	                            <div class="form-inline">
	                                <label class="fieldinput  col-sm-4">Đến ngày: </label>
	                                <input type="date" name="denngay" class="form-control" value="" required="required">
	                            </div>
	                            <div class="form-inline">
	                                <label class="fieldinput col-sm-4">Địa điểm: </label>
	                                <input type="text" name="diadiem" class="form-control required name" id="" value="khu A" placeholder="Input field"  data-trigger="manual" data-content="Bạn cần phải nhập vào trường này,ít nhất 3 ký tự.">
	                            </div>
	                            <div class="form-inline">
	                                <label class="fieldinput col-sm-4">Điểm rèn luyện: </label>
	                                <input type="text" name="diemrl" class="form-control required" id="" value="40" placeholder="Input field" data-trigger="manual" data-content="Bạn cần phải nhập vào trường này" >
	                            </div>
	                            <div class="form-inline">
	                                <label class="fieldinput col-sm-4">Điểm CTXH: </label>
	                                <input type="text" name="diemctxh" class="form-control required" id="" value="40" placeholder="Input field" data-trigger="manual" data-content="Bạn cần phải nhập vào trường này" >
	                            </div>
	                            <div class="form-inline">
	                ...
	                <button type="submit" class="btnluuthaydoi btn btn-success" onclick="window.location='33.1HoatDong_CBDK_ChiTiet_TC.jsp'">Lưu thay đổi</button>
	            </div>
	        </div>
	        <!-- ket thuc container -->
