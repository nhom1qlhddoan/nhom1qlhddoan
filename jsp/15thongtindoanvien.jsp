				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav">
							<li class="active"><a href="10hoatdongSV.jsp"> Hoạt
									động</a></li>
						</ul>
						<ul class="nav navbar-nav">
								...
								<div class="khungchitiet">
									...
									<form class="" action="" method="POST" role="form">
										...
										<div class="form-group">
											<label class="fieldinput  col-sm-4" readonly>Giới
												tính </label> <input type="radio" name="nam" value="Bike"
												required="required" readonly>Nam <input type="radio"
												name="nu" value="Bike" readonly>Nữ <br>
										</div>
										<div class="form-inline">
										...
										<div class="form-inline">
											<label class="fieldinput col-sm-4">SĐT: </label> <input
												type="text" name="sdt"
												class="form-control number required phone " id=""
