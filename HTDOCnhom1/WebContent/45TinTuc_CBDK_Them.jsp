             ...
             <jsp:include page="breakingnew.jsp"/> 
               <!-- ket thuc breakingnew -->
				...
				<div id="main-content">
					...
					<button type="submit" class="btnluuthaydoi btn btn-success" onclick="window.location='46TinTuc_CBDK_Them_TC.jsp';" >Thêm thông báo</button>
