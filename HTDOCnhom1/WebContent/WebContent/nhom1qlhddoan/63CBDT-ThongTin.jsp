                    ...
                    <div class="khungchitiet">
                        <form class="" action="" method="POST" role="form">
                            <div class="form-inline">
                                ...
                                <input type="text" name="massv" class="form-control required name" id="" value="" placeholder="1411083" data-trigger="manual" data-content="Bạn cần phải nhập vào trường này,ít nhất 3 ký tự.">
                            </div>
                            <div class="form-inline">
                                <label class="fieldinput col-sm-4">Tên SV: </label>
                                <input type="text" name="tensv" class="form-control required name" id="" value="" placeholder="Huỳnh Thị Thắm"  data-trigger="manual" data-content="Bạn cần phải nhập vào trường này,ít nhất 3 ký tự.">
                            </div>
                            <div class="form-inline">
                            ...
                            <div class="form-inline">
                                ...
                                <select name="khoa" id="input" class="form-control" required="required">
                            ...
                            <div class="form-inline">
                                ...
                                <select name="lop" id="input" class="form-control" required="required">
                            ...
                            <div class="form-inline">
                                ...
                                <input type="text" name="cmnd" class="form-control required phone" id="" value="" placeholder="01653708276" data-trigger="manual" data-content="Bạn cần phải nhập vào trường này,ít nhất 8 kí tự số." >
                            </div>
                        </form>
                    </div>
