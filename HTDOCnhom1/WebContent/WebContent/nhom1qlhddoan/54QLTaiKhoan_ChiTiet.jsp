                ...
                <div class="khungchitiet">
                    ...
                    <form class="" action="xulythaydoitaikhoan" method="POST" role="form">
                        <div class="form-inline">
                            ...
                            <input  type="text" name="masv" class="form-control" id="" value="14110100" readonly="readonly">
                        </div>
                        <div class="form-inline">
                            <label class="fieldinput col-sm-4">Tài khoản Email: </label>
                            <input type="Email" class="form-control" id="" value="14110100@student.hcmute.edu.vn"  readonly required="required">
                        </div>
                        <div class="form-inline">
