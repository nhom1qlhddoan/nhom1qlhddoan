             ...
             <jsp:include page="breakingnew.jsp"/> 
               <!-- ket thuc breakingnew -->
				...
				<div class="khungchitiet">
						<h1 class="text-center">Thêm đoàn viên</h1>
						<div class="khungchitiet">
							...
							<div class="form-inline">
								...
								<input
									...
									data-placement="right"
									data-trigger="manual"
									data-content="Ít nhất 9 số! VD: 250950920" 
									minlength="9"
									required>
							</div>	
						</form>
					...
					<button type="submit" class="btnluuthaydoi btn btn-success" onclick="window.location='41QLDoanVien_CBDK_Them_TC.jsp'">Thêm đoàn viên</button>
