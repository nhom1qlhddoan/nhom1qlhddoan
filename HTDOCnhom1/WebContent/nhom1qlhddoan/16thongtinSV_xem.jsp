                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            <ul class="nav navbar-nav">
                                <li class="#"><a href="10hoatdongSV.jsp"> Hoạt động</a></li>
                            </ul>
                            <ul class="nav navbar-nav">
                    ...
                    <div class="khungchitiet">
                        <form class="" action="" method="POST" role="form">
                            <div class="form-inline">
                                ...
                                <input type="disabled" name="mahd" class="form-control" id="" placeholder="HD01" disabled>
                            </div>
                            <div class="form-inline">
                                <label class="fieldinput col-sm-4">Tên HĐ: </label>
                                <input type="text" name="tenhd" class="form-control" id="" placeholder="Tiep Suc Mua Thi"disabled>
                            </div>
                            <div class="form-inline">
