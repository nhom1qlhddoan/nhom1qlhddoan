    ...
    <form action="" method="POST" role="form">
        <div class="form-inline">   	
       		...
       		<div  class="form-inline col-sm-9">
				...
				<input size="40" type="text" class="form-control email required" id="" placeholder="14110100@student.hcmute.edu.vn" data-placement="top" data-trigger="manual" data-content="Bạn cần phải nhập vào trường này email sinh viên của bạn.">
       		</div>
        </div>
        <div class="form-inline">
       		...
       		<div  class="form-inline col-sm-9">
		  		...
		  		<input size="40" type="password" class="form-control password1 required" id="" placeholder="12031996" data-placement="bottom" data-trigger="manual" data-content="Bạn cần phải nhập vào ít nhất 8 ký tự, ít nhất 1 số, 1 kí tự HOA, 1 kí tự thường.">
